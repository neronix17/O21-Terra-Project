...
namespace TerraCore
{
	public static class WorldGridExtension
	{
		...
		public static int GetTileNeighborByDirection6WayInt(this WorldGrid grid, int tileID, int dir)
		{
			...
			foreach (int tmpNeighbor in tmpNeighbors)
			{
		...
		public static void GetTileGraphicDataFromNeighbors(this WorldGrid grid, int tileID, out int atlasX, out int atlasZ, out int rotDir, TileNeightborPredicate validator)
		{
			...
			switch (num)
			{
				...
				case 3:
					{
						atlasX = 3;
						int num5 = Math.Abs(list[0] - list[1]);
						int num6 = Math.Abs(list[1] - list[2]);
						int num7 = Math.Abs(list[0] - list[2]);
						if (num5 == 3 || num6 == 3 || num7 == 3)
						{
							...
							else if (num6 == 1 || num6 == 5)
							{
								item = list[0];
							}
							else if (num7 == 1 || num7 == 5)
							{
								item = list[1];
							}
						}
						else if ((num5 == 2 || num5 == 4) && (num6 == 2 || num6 == 4) && (num7 == 2 || num7 == 4))
						{
							atlasX++;
						}
				...
				case 4:
					{
						atlasX = 5;
						int num5 = Math.Abs(list[0] - list[1]);
						int num6 = Math.Abs(list[0] - list[2]);
						int num7 = Math.Abs(list[0] - list[3]);
						int num8 = Math.Abs(list[1] - list[2]);
						int num9 = Math.Abs(list[1] - list[3]);
						int num10 = Math.Abs(list[3] - list[3]);
						int num11 = 0;
						if (num5 == 3)
						{
							num11++;
